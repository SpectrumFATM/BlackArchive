...
public class ShipDoorEntity extends BlockEntity {
    ...
    private Long pos = 0L;
    private String exteriorDimension = "";

    public ShipDoorEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.SHIP_DOOR_ENTITY.get(), pos, state);
    }

    public String getExteriorDimension() {
        return exteriorDimension != null ? exteriorDimension : "";
    }
    ...
    public void setExteriorDimension(String exteriorDimension) {
    ...
    public void load(CompoundTag tag) {
        ...
        this.exteriorDimension = tag.getString("exteriorDimension");
    }
    ...
    protected void saveAdditional(CompoundTag tag) {
        ...
        tag.putString("dimension", this.exteriorDimension != null ? this.exteriorDimension : "");
    }
}