...
public class ModItems {
    ...
    public static final RegistrySupplier<Item> SONIC13 = registerItem("13thsonic", () -> new SonicItem(new Item.Properties().stacksTo(1), "item.sonic13.tooltip", ChatFormatting.GOLD), true);
    public static final RegistrySupplier<Item> SONIC14 = registerItem("14thsonic", () -> new SonicItem(new Item.Properties().stacksTo(1), "item.sonic.tooltip", ChatFormatting.BLUE), true);
