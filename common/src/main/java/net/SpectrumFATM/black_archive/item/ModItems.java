...
public class ModItems {
    ...
    public static final RegistrySupplier<Item> ANGEL_SPAWN_EGG = registerItem("weeping_angel_egg", () -> new SpawnItem(new Item.Settings(), "weeping_angel", "item.weeping_angel.tooltip"), true);
