...
public class ModUpgrades {
    ...
    static {
        REMOTE_UPGRADE = UPGRADE_DEFERRED_REGISTRY.register("remote_upgrade", () -> {
            ...
            return (new Upgrade(i::getDefaultInstance, TRUpgrades.LANDING_PAD, RegistryHelper.makeKey("remote_upgrade"), Upgrade.UpgradeType.SUB_UPGRADE)).setSkillPointsRequired(15).setPosition(8.0, 3.0);
        });
        TELEPATHIC_UPGRADE = UPGRADE_DEFERRED_REGISTRY.register("telepathic_upgrade", () -> {
            Item i = Items.PLAYER_HEAD;
            Objects.requireNonNull(i);
            return (new Upgrade(i::getDefaultInstance, TRUpgrades.DIMENSION_TRAVEL, RegistryHelper.makeKey("telepathic_upgrade"), Upgrade.UpgradeType.SUB_UPGRADE)).setSkillPointsRequired(25).setPosition(7.0, 6.0);
        });
