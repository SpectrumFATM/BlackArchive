...
public class DalekModel<T extends DalekEntity> extends EntityModel<T> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		.uv(81, 79).cuboid(5.0F, -28.0F, -19.0F, 2.0F, 2.0F, 9.0F, new Dilation(0.0F))
		...
		.uv(51, 0).cuboid(-7.0F, -35.0F, -8.0F, 14.0F, 1.0F, 15.0F, new Dilation(0.0F))
		...
		ModelPartData head = modelPartData.addChild("head", ModelPartBuilder.create().uv(37, 78).cuboid(-1.0F, -2.0F, -15.0F, 2.0F, 2.0F, 9.0F, new Dilation(0.0F))
		.uv(0, 0).cuboid(-2.0F, -3.0F, -17.0F, 4.0F, 4.0F, 2.0F, new Dilation(0.0F))
		...
		ModelPartData cube_r2 = head.addChild("cube_r2", ModelPartBuilder.create().uv(11, 4).mirrored().cuboid(-1.0F, -3.0F, -1.0F, 2.0F, 3.0F, 2.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(4.0F, -3.0F, 0.0F, 0.0F, 0.0F, 0.3491F));

		ModelPartData cube_r3 = head.addChild("cube_r3", ModelPartBuilder.create().uv(11, 4).cuboid(-1.0F, -3.0F, -1.0F, 2.0F, 3.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-4.0F, -3.0F, 0.0F, 0.0F, 0.0F, -0.3491F));
